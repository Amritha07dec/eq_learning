...
# === Import your modules ===
from train import LSTMClassifier, train, pad_samples, split_data, TimeSeriesDataset
...
def objective(trial):
    ...
    try:
        ...
        if "out of memory" in str(e):
            print("Warning: CUDA out of memory, skipping trial.")
            torch.cuda.empty_cache()
            return 0.0  # low score so Optuna skips this trial
        else:
            raise e
    ...
    # return max(val_accs)  # Max validation accuracy over epochs
