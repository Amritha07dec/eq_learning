...
from train import (
    ...
    LSTMClassifier, train, Conv1DLSTMClassifier, AttentionLSTMClassifier
)
...
plt.tight_layout()
plt.savefig("learning_curve832_attenlstm.png")
print("📊 Learning curve saved to learning_curve832_attenlstm.png")
...
with open("1_layer_attenlstm_model_832.pth", "wb") as f:
...
print("✅ Model saved to 1_layer_attenslstm_model_832.pth")